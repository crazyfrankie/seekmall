...
const (
	...
	ProductService_ReleaseProduct_FullMethodName = "/product.ProductService/ReleaseProduct"
...
func (c *productServiceClient) ReleaseProduct(ctx context.Context, in *ReleaseProductRequest, opts ...grpc.CallOption) (*ReleaseProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReleaseProductResponse)
	err := c.cc.Invoke(ctx, ProductService_ReleaseProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductServiceServer) ReleaseProduct(context.Context, *ReleaseProductRequest) (*ReleaseProductResponse, error) {
...
func _ProductService_ReleaseProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseProductRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).ReleaseProduct(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_ReleaseProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ReleaseProduct(ctx, req.(*ReleaseProductRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_ReleaseProduct_Handler,
		},
		{
	...
	Metadata: "idl/seekmall/product.proto",
}
