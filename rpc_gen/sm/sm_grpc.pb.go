...
const (
	SmsService_SendSms_FullMethodName   = "/sm.SmsService/SendSms"
	SmsService_VerifySms_FullMethodName = "/sm.SmsService/VerifySms"
)
...
func (c *smsServiceClient) VerifySms(ctx context.Context, in *VerifySmsRequest, opts ...grpc.CallOption) (*VerifySmsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifySmsResponse)
	err := c.cc.Invoke(ctx, SmsService_VerifySms_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSmsServiceServer) VerifySms(context.Context, *VerifySmsRequest) (*VerifySmsResponse, error) {
...
func _SmsService_VerifySms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifySmsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SmsServiceServer).VerifySms(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SmsService_VerifySms_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SmsServiceServer).VerifySms(ctx, req.(*VerifySmsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SmsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SmsService_VerifySms_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "idl/seekmall/sm.proto",
}
